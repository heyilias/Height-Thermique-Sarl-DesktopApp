...
namespace Height_Thermique_Sarl
{
    public partial class Devis : Form
    {
        ...
        private void Facture_Load(object sender, EventArgs e)
        {
            ...
            // Devis table 
            dapDevis = new SqlDataAdapter("select * from Devis", cnx);
            dapDevis.Fill(ds, "Devis");
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ds.Tables["Devis"].Rows.Add(ligne);
                cb = new SqlCommandBuilder(dapDevis);
                dapDevis.Update(ds, "Devis");
                ...
                for (int i = 0; i < dgvallProdutcs.Rows.Count - 1; i++)
                {
                    ligne = ds.Tables["Produits"].NewRow();
                    ...
                    ds.Tables["Produits"].Rows.Add(ligne);
